    ...
    <div class="view_bieudo">
        ...
        <div class="view_bieudo_table">
            ...
            <table id="myTable">
                ...
                <?php
                $i = 1;
                foreach ($tablehanghoa as $tablehanghoaa) {
                    extract($tablehanghoaa);
                    echo '
                    <tr>
                        <td>' . $i . '</td>
                        <td>' . $tenhanghoa . '</td>
...
<?php
$showbieudo = '';
foreach ($hanghoabieudo as $hanghoabieudoo) {
    extract($hanghoabieudoo);
    $showbieudo .= '"' . $tenhanghoa . '",';
}
?>
<?php
$showbieudosolieu = '';
...
<script>
    ...
    new Chart("myChart", {
        ...
        options: {
            title: {
                display: true,
                text: "Biêu đồ hàng hoá có lượt xem nhiều nhất"
            }
        }
    });
</script>